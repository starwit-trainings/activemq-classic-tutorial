...
public class App {
    ...
    private static class MyListener implements MessageListener {
        ...
        public void onMessage(Message message) {
            ...
            try {
                ...
                StudentResult result = parse(msg.getText());
    ...
    private static StudentResult parse(String message) {
        ObjectMapper mapper = new ObjectMapper();
        StudentResult result = null;
        try {
            result = mapper.readValue(message, StudentResult.class);
        } catch (JsonProcessingException e) {
            log.error("Couldn't parse student result object " + e.getMessage());
        }
        return result;
    }
